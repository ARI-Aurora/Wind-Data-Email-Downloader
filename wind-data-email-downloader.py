...
class emailHandler:
    ...
    def cleanArchive(self): # TODO Will need to also clean the SRA data files!
        ...
        senders = ['447498823060@packet-mail.net', 'status@support.zephirlidars.com', 'status@support.zxlidars.com']
    ...
    def checkEmailForData(self):
        if self.imap is not None:
            ...
            expectedSenders = ['447498823060@packet-mail.net', 'status@support.zephirlidars.com', 'status@support.zxlidars.com']
